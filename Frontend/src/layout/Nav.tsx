...
export default function Navbar() {
  ...
  return (
    <div className="relative">
      <header
        className={`bg-white shadow border-b sticky top-0 left-0 right-0 z-40 transition-all duration-300 ease-in-out ${scrolled ? "py-3" : "py-6"
          }`}
      >
                ...
                >
                  <DropdownMenuItem asChild>
                    <NavLink
                      to="/"
                      className={({ isActive }) =>
                        `flex items-center gap-2 px-2 py-1 rounded transition-colors duration-200 hover:text-primary ${isActive ? "text-primary" : "text-gray-700"
                        }`
                      }
                    >
                      <Home className="text-[#00b2ff]" size={16} />
                      Home
                    </NavLink>
                  </DropdownMenuItem>
