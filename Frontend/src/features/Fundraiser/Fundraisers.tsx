...
const Fundraisers: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#feedf4] py-12 sm:px-2">
        <div className="max-w-[95%] sm:max-w-[80%] mx-auto text-center px-4 sm:px-0 ">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-[#1cbeff]">
            Sparking Possibilities One Donation  <br className="block sm:hidden" />
            <span className="inline sm:inline-block"> At A Time </span>
          </h2>
          {/* Features Grid */}
