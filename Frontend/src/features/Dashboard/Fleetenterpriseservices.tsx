...
<div className="bg-white rounded-xl shadow-lg w-30 h-28 md:w-32 md:h-32 flex items-center justify-center p-3 mt-0 md:mt-4">
  <img
    src={img1}
    alt="Fleet Icon"
    loading="lazy"
  ...
  />
      ...
      <div className="max-w-[80%] sm:max-w-[80%] mx-auto flex flex-col md:flex-row items-center justify-between gap-10 py-6 px-4 md:px-8 sm:py-16">
          {/* Left Side */}
