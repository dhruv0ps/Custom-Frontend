    ...
    const features = [
        {
            ...
            desc: "Easily manage your car listings, enquiries, and service requests in one place. Listings are automatically updated for your records.",
        },
        {
            icon: icon2,
            title: "Real-Time Enquiry Tracking",
            desc: "Receive instant notifications for all vehicle enquiries. Monitor responses and maintain a clear view of your interactions.",
        },
        {
            icon: icon3,
    ...
    const mockSellLeads = [
        {
            ...
            exteriorImages: [
                {
                    url: "https://s3.ap-southeast-2.amazonaws.com/wheelz.au/media/car/BMW/BMW+M5+2024.png",
                },
        ...
        },
        {
            ...
            exteriorImages: [
                {
                    url: "https://s3.ap-southeast-2.amazonaws.com/wheelz.au/media/car/Audi/Audi+S6+2024.png",
                },
...
const mockBuyLeads = [
  {
    ...
    make: "Audi",
    model: "A5",
    createdAt: new Date(new Date().setDate(new Date().getDate() - 10)).toISOString(), // 10 days ago
    variant: [
      {
        image: "https://s3.ap-southeast-2.amazonaws.com/wheelz.au/media/car/Audi/Audi+A5+2024.png",
        bodyType: "Coupe",
        fuelType: "Petrol",
      },
    ],
  },
  {
    ...
    variant: [
      {
        image: "https://s3.ap-southeast-2.amazonaws.com/wheelz.au/media/car/BMW/BMW+IX1+2024.png",
        bodyType: "Wagon",
        fuelType: "Electric",
      },
    ],
  },
  {
    ...
    variant: [
      {
        image: "https://s3.ap-southeast-2.amazonaws.com/wheelz.au/media/car/Genesis/Genesis+GV70+2024.png",
        bodyType: "SUV",
        fuelType: "Petrol",
      },
    ],
...
`}
            ...
            <div className="relative w-full h-[60vh] sm:h-[60vh] md:h-[65vh] lg:h-[89vh]  overflow-hidden bg-white">
                <video
                    className="absolute inset-0 w-full h-full object-cover object-left-top sm:object-left z-0 filter brightness-125"
                    src={video}
                    autoPlay
                    loop
                    muted
                ...
                <div className="relative z-20 flex flex-col justify-end h-full">
                    ...
                    <div className="bg-primary py-4 px-2 sm:py-4 w-full">
                        <div className="flex justify-center gap-4 space-x-8 sm:space-x-32 flex-wrap">
                            ...
                            >
                                {/* Default Text */}
                                <span className="block w-full transition-opacity duration-200 group-hover:opacity-0">Enter</span>
            ...
            <div className="bg-[#b7eaff] py-12 ">
               ...
               max-w-[550px] mx-auto relative w-full break-words`}
                            >
                                ...
                                >
                                    <img src={item.icon || "/placeholder.svg"} alt={item.title} className="w-28 h-28 object-contain" />
                                </div>
            ...
            <div className="bg-primary">
                <div className="sm:max-w-[80%] max-w-[95%] mx-auto">
                    <h1 className="text-black font-bold  text-2xl sm:text-3xl mb-2 flex justify-center pt-6">My Garage</h1>
                        ...
                        <div className="flex flex-col ">
                            <div className="relative md:p-2">
                                <div
                                    ...
                                    style={{
                                        background: "linear-gradient(to bottom, white 50%, #00B2FF 50%)",
                                    }}
                                ></div>
                            ...
                            <div className="relative p-2">
                                    ...
                                    <div className="p-2">
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-1 mb-4">
                                                <h2 className="text-lg text-white font-semibold tracking-tight">Your Listings</h2>
                                                <p className="text-sm text-white">Manage and review all your used car listings.</p>
                                            </div>
                                        </div>
                                        <div
                                            className={cn(
                                                ...
                                                mockSellLeads?.length > 0
                                                    ? "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4"
                                                    : "",
                                            )}
                                        >
                                            {!loading ? (
                                                mockSellLeads?.length > 0 ? (
                                                    mockSellLeads?.map((listing: any) => (
                                                        <Card className="w-full mb-4 cursor-pointer bg-white overflow-hidden" key={listing._id}>
                                                            <CardContent className="p-0 !h-[240px] sm:!h-[260px] flex items-center justify-center bg-gray-50">
                                                                <div className="w-full h-full flex items-center justify-center">
                                                                    <img
                                                                        className="w-full h-full object-contain px-2"
                                                                        src={listing.exteriorImages[0]?.url || "/placeholder.svg"}
                                                                    ...
                                                                    <div className="flex w-full flex-col mb-4">
                                                                        <div className="flex items-center justify-between">
                                                                            <h2 className="font-semibold text-lg">
                                                                                {listing.carDetails.make} {listing.carDetails.model} {listing.carDetails.year}
                                                                            </h2>
                                                                            <h2 className="font-semibold text-lg flex gap-1">
                                                                                <Gauge className="text-primary" /> {listing.condition.odometer} km
                                                                            </h2>
                                                                        </div>
                                                                        <p className="text-xs">{timeAgo(listing.createdAt)}</p>
                                                                    </div>
                                                                    <div className="text-sm text-muted-foreground flex gap-1 flex-wrap">
                                                                        <Badge variant="outline" className="bg-primary rounded-sm text-white">
                                                    ...
                                                    <div className="flex w-full items-center justify-center rounded-lg border border-dashed shadow-sm px-4 py-8">
                                                        <div className="flex flex-col items-center gap-1 text-center">
                                                            <h3 className="text-2xl font-bold tracking-tight">Ready to Sell Your Car?</h3>
                                                            <p className="text-sm text-muted-foreground mb-4 text-white">
                                                                List your car today and connect with potential buyers in minutes.
                                                            </p>
                                                            <Button
                                ...
                                <TabsContent value="enquiries">
                                    <div className="p-2">
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-1 mb-4">
                                                <h2 className="text-lg text-white font-semibold tracking-tight">Your Enquiries</h2>
                                                <p className="text-sm text-white">Track and manage your car enquiries.</p>
                                            </div>
                                        </div>
                                        <div
                                            className={cn(
                                            ...
                                            {!loading ? (
                                                mockBuyLeads?.length > 0 ? (
                                                    mockBuyLeads?.map((enquiry: any) => (
                                                        <Card className="w-full mb-4 cursor-pointer bg-white" key={enquiry._id}>
                                                            <CardContent className="p-0 !h-[240px] sm:!h-[260px] flex items-center justify-center bg-white">
                                                                {enquiry?.variant?.length > 0 ? (
                                                                    <div className="w-full h-full flex items-center justify-center">
                                                                             <img
                                                                            className="w-full h-full object-contain px-2"
                                                                            src={enquiry?.variant[0].image || "/placeholder.svg" || "/placeholder.svg"}
                                                                            alt="car"
                                                                        />
                                                                    </div>
                                                                ) : (
                                                            ...
                                                            <CardFooter className="py-2 px-3">
                                                                <div className="flex flex-col items-start text-left text-sm transition-all w-full">
                                                                    <div className="mb-2">
                                                                        ...
                                                                        <p className="text-xs">{timeAgo(enquiry?.createdAt || new Date())}</p>
                                                                    </div>
                                                                    <div className="text-sm text-muted-foreground flex gap-1 flex-wrap">
                                                                        {enquiry?.variant?.length > 0 && (
                                                    ...
                                                    <div className="flex w-full items-center justify-center rounded-lg border border-dashed shadow-sm px-4 py-8">
                                                        <div className="flex flex-col items-center gap-1 text-center">
                                                            <h3 className="text-2xl font-bold tracking-tight">Ready to Buy A New Car?</h3>
                                                            <p className="text-sm text-white mb-4">
                                                                Discover your perfect vehicle today and drive away with the best deal.
                                                            </p>
                                                            <Button
                                                                className="bg-white text-black hover:text-black hover:bg-white transform hover:scale-105 transition-all duration-300"
                                ...
                                <TabsContent value="services">
                                    <div className="p-2">
                                        <div className="space-y-1 mb-4">
                                            <h2 className="text-lg text-white font-semibold tracking-tight">Your Services</h2>
                                            <p className="text-sm text-white">Track and manage all your requests.</p>
                                        </div>
                                        <div
                                            className={cn(
                                                "",
                                        ...
                                        >
                                            {!loading ? (
                                                mockServices?.length > 0 ? (
                                                                ...
                                                                <div className="flex justify-between items-center">
                                                                    <div>
                                                                        ...
                                                                        <p className="text-sm text-gray-500">
                                                                            {service.type === "Mates Rates" && service.service_type}
                                                                        </p>
                                                                    </div>
                                                                    <div className="bg-primary text-white p-3 rounded">
                                                                        <p className="text-sm sm:text-base">You Saved</p>
                                                                        <p className="font-bold text-lg sm:text-xl md:text-2xl">
                                                                            {service.type === "Mates Rates" && service?.quoteDetails?.totalSavings.toFixed(2)}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </CardContent>
                                                    ...
                                                    <div className="flex w-full items-center justify-center rounded-lg border border-dashed shadow-sm px-4 py-8">
                                                        <div className="flex flex-col items-center gap-1 text-center">
                                                            <h3 className="text-2xl font-bold tracking-tight">Ready to Save On A Service?</h3>
                                                            <p className="text-sm text-white mb-4">
                                                                Discover great deals and get the best value for your needs today!
                                                            </p>
                                                            <Button
                                                                className="bg-white text-black hover:text-black hover:bg-white transform hover:scale-105 transition-all duration-300"
