...
const MembershipBenefits: React.FC = () => {
    ...
    const benefits = [
        ...
        },
        {
            ...
            description: "Gain automatic entry into every promotional draw we decide to run, giving you a chance to win exciting cash prizes just by being a part of our community.",
        },
        {
            number: "5",
            title: "Ambassador",
  ...
  {item.number}
      ...
      <div className="max-w-full mx-auto sm:max-w-[80%] md:px-4 flex items-center justify-between   sm:px-0">
        ...
        Sell Free, Buy Smart, Win,
         <span className="block sm:inline text-primary text-lg sm:text-3xl sm:ml-1 uppercase">SAVE BIG!</span>
        </h2>
      </div>
